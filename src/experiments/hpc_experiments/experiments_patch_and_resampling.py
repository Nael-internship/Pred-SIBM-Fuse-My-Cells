...
def exp_mae_4(fold=1):
    ...
    ### General Parameters ###
    iteration = 4
    experiment_name = f"FMC_RUNet_DoubleStep_224_06_MAE_I{iteration}_Fold{fold}"
    learning_rate = 0.001
    save_step = 50
    ...
    checkpoint_path = p.checkpoints_path / f"FMC_RUNet_DoubleStep_224_06_MAE_I3_Fold{fold}" / checkpoints[int(fold)]
